...
export default function InputsDropdown({ fw, setFw }) {
  ...
  return (
    <>
      ...
      <div className="ph-stage tall" style={{ marginTop: 14, display: "flex", alignItems: "center", justifyContent: "center", overflow: "visible", minHeight: state === "open" ? 240 : undefined }}>
